...
use Clicproxy\PolleetBundle\Form\AnswerType;
...
class AnswerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ClicproxyPolleetBundle:Answer')->findAll();
     ...
     * @Method("POST")
     * @Template("ClicproxyPolleetBundle:Answer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ClicproxyPolleetBundle:Answer')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ClicproxyPolleetBundle:Answer:edit.html.twig")
     */
