...
use Clicproxy\PolleetBundle\Form\PollType;
...
class PollController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ClicproxyPolleetBundle:Poll')->findAll();
     ...
     * @Method("POST")
     * @Template("ClicproxyPolleetBundle:Poll:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ClicproxyPolleetBundle:Poll')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ClicproxyPolleetBundle:Poll:edit.html.twig")
     */
